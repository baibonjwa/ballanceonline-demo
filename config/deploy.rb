...
set :application_name, 'ballanceonline'
set :domain, 'ballanceonline.com'
set :deploy_to, '/var/www/ballanceonline.com'
set :repository, 'git@github.com:tlbai/ballanceonline.git'
set :branch, 'master'
